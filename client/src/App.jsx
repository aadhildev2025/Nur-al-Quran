...
const Footer = () => (
  <footer className="bg-spiritual-950 text-white py-16 px-4">
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 text-center md:text-left text-spiritual-400 font-light">
        <div>
          <p className="text-white font-bold mb-1">Aadhil • Web Developer</p>
          <a href="mailto:aadhildev2025@gmail.com" className="hover:text-accent-gold transition-colors block mb-4">aadhildev2025@gmail.com</a>
          <p className="text-xs opacity-60">This is an open source page for all users to learn and benefit from.</p>
        </div>
        <div className="md:text-right">
          <p>&copy; {new Date().getFullYear()} Nur al-Quran Learning Platform. All rights reserved.</p>
          <p className="text-sm mt-2 opacity-60 italic">In the service of the Ummah</p>
        </div>
      </div>
    </div>
  </footer>
